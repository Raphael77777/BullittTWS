...
public class GraphicalTheme {
    ...
    /* VALUES */
    public final static String title = "BULLITT - OLDTWS";
    ...
    /* COLORS */
    public final static Color primary_color = new Color(19, 209, 150);
    public final static Color secondary_color = new Color(209, 19, 78);
    public final static Color light_color = new Color(255, 255, 255);
    public final static Color dark_color = new Color(16, 16, 16);

    /* FONTS */
    public final static Font font_bold = new Font("Agency FB", Font.BOLD, 17);
    public final static Font font_italic = new Font("Agency FB", Font.ITALIC, 17);
    public final static Font font_regular = new Font("Agency FB", Font.PLAIN, 17);
